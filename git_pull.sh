...
ShellURL=https://github.com/dawang1110/jd_shell
ScriptsURL=https://github.com/dawang1110/DW_Scripts
...
function Git_PullScripts {
  ...
  git clone https://github.com/dawang1110/DW_Scripts /root/jd/sc1
